...
def train(currepoch, epoch):
    ...
    for batch_idx in range(len(dataloader)):
        ...
        torch.save(model.state_dict(), './weights_cnn/network_train_filtered.ckpt')
    ...
    torch.save(model.state_dict(), './checkpoints_cnn/network_train_filtered_epoch_{}.ckpt'.format(currepoch + 1))
